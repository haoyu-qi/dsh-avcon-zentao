...
export function AppFrame({
  ...
  const responsiveDefault = viewport >= 3200 ? 360 : viewport >= 2000 ? 320 : SIDEBAR_DEFAULT
  const sidebarPreference = sidebarCollapsed
    ? 0
    : panels.sidebar === 0 ? responsiveDefault : panels.sidebar === SIDEBAR_DEFAULT ? responsiveDefault : panels.sidebar
